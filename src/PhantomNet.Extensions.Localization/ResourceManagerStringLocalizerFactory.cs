...
{
    public class AssemblyAwareResourceManagerStringLocalizerFactory : IStringLocalizerFactory
    {
        ...
        public IStringLocalizer Create(Type resourceSource)
        {
            ...
            var baseName = string.IsNullOrEmpty(_resourcesRelativePath) || !typeInfo.FullName.StartsWith(_hostingEnvironment.ApplicationName)
                ? typeInfo.FullName
                : _hostingEnvironment.ApplicationName + "." + _resourcesRelativePath
                    + TrimPrefix(typeInfo.FullName, _hostingEnvironment.ApplicationName + ".");
